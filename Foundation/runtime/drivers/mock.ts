...
import type { Driver, ToolInput, ToolOutput, ToolResult, DriverContext } from "./index.js";

export const mockDriver: Driver = {
    name: "mock",

    async execute(input: ToolInput, _ctx: DriverContext): Promise<ToolResult<ToolOutput>> {
        return {
            payload: {
                answer: [
